  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <nav className="bg-white border-b border-neutral-200 sticky top-0 z-50 shadow-sm">
        ...
        {/* Mobile menu */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-neutral-200 animate-slide-down">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="pt-2 mt-2 border-t border-neutral-200">
                <button
                  ...
                  className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-base font-medium text-error-600 hover:bg-error-50 transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                  </svg>
